...
<aside class="sidebar scrollbar-thin">
    ...
    <div class="sidebar-section">
        <?php $resActive = is_active('/residents'); ?>
        <button type="button" class="sidebar-toggle" aria-expanded="<?= $resActive ? 'true' : 'false' ?>">
            <span>Resident Management</span>
            <svg class="sidebar-toggle-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <div class="sidebar-links-group <?= $resActive ? '' : 'collapsed' ?>">
            ...
            <a href="<?= page_url('/residents/create') ?>" class="sidebar-link <?= active_class('/residents/create') ?>">
    ...
    <div class="sidebar-section">
        <?php $repActive = is_active('/reports'); ?>
        <button type="button" class="sidebar-toggle" aria-expanded="<?= $repActive ? 'true' : 'false' ?>">
            <span>Reports & Queries</span>
            <svg class="sidebar-toggle-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <div class="sidebar-links-group <?= $repActive ? '' : 'collapsed' ?>">
            ...
            <a href="<?= page_url('/reports/custom') ?>" class="sidebar-link <?= active_class('/reports/custom') ?>">
            ...
            <a href="<?= page_url('/reports/adhoc') ?>" class="sidebar-link <?= active_class('/reports/adhoc') ?>">
    ...
    <div class="sidebar-section">
        <?php $appActive = is_active('/approvals'); ?>
        <button type="button" class="sidebar-toggle" aria-expanded="<?= $appActive ? 'true' : 'false' ?>">
            <span>Approvals</span>
            <svg class="sidebar-toggle-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <div class="sidebar-links-group <?= $appActive ? '' : 'collapsed' ?>">
            ...
            <a href="<?= page_url('/approvals/authorization') ?>" class="sidebar-link <?= active_class('/approvals/authorization') ?>">
    ...
    <div class="sidebar-section">
        <?php $refActive = is_active('/references'); ?>
        <button type="button" class="sidebar-toggle" aria-expanded="<?= $refActive ? 'true' : 'false' ?>">
            <span>Reference Tables</span>
            <svg class="sidebar-toggle-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <div class="sidebar-links-group <?= $refActive ? '' : 'collapsed' ?>">
            ...
            <a href="<?= page_url('/references/admin') ?>" class="sidebar-link <?= active_class('/references/admin') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                Admin
            </a>
            <a href="<?= page_url('/references/cases') ?>" class="sidebar-link <?= active_class('/references/cases') ?>">
            ...
            <a href="<?= page_url('/references/nationality') ?>" class="sidebar-link <?= active_class('/references/nationality') ?>">
            ...
            <a href="<?= page_url('/references/municipality') ?>" class="sidebar-link <?= active_class('/references/municipality') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                Municipality
            </a>
            <a href="<?= page_url('/references/state') ?>" class="sidebar-link <?= active_class('/references/state') ?>">
            ...
            <a href="<?= page_url('/references/country') ?>" class="sidebar-link <?= active_class('/references/country') ?>">
            ...
            <a href="<?= page_url('/references/religion') ?>" class="sidebar-link <?= active_class('/references/religion') ?>">
            ...
            <a href="<?= page_url('/references/communication') ?>" class="sidebar-link <?= active_class('/references/communication') ?>">
    ...
    <div class="sidebar-section">
        <?php $sysActive = is_active('/system'); ?>
        <button type="button" class="sidebar-toggle" aria-expanded="<?= $sysActive ? 'true' : 'false' ?>">
            <span>System</span>
            <svg class="sidebar-toggle-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <div class="sidebar-links-group <?= $sysActive ? '' : 'collapsed' ?>">
            <a href="<?= page_url('/system/users') ?>" class="sidebar-link <?= active_class('/system/users') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                Users
            </a>
            <a href="<?= page_url('/system/roles') ?>" class="sidebar-link <?= active_class('/system/roles') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                Roles
            </a>
            <a href="<?= page_url('/system/options') ?>" class="sidebar-link <?= active_class('/system/options') ?>">
            ...
            <a href="<?= page_url('/system/todo') ?>" class="sidebar-link <?= active_class('/system/todo') ?>">
